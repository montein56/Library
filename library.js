...
function makeLibrary() {
  if (MyLibrary === null || MyLibrary.length < 3) {
    //MIGHT NOT EXIST IN LOCAL STORAGE OR COULD BE EMPTY [will have 2 brackets, hence the 3 test]
    alert(
...
function hideInputs() {
  //IN EDIT FORM: To be Unhidden, ONCE TITLE OF BOOK TO BE EDITED IS SELECTED
...
const saveBook = (ev) => {
  ...
  if (newTitle === "") {
    newTitleElement.style.backgroundColor = "pink";
    newTitleElement.style.border = "red dotted 2px";
    newTitleElement.placeholder = "Book Title is a must";
    return;
  }
  newTitleElement.style.backgroundColor = "var(--green";
  newTitleElement.style.border = "none";
  newTitleElement.placeholder = "Enter the book name [required]";

  let newAuthor = document.getElementById("author").value;
  const newAuthorElement = document.getElementById("author");
  if (newAuthor === "") {
    newAuthorElement.style.backgroundColor = "pink";
    newAuthorElement.placeholder = "Every book has an author... No?";
    newAuthorElement.style.border = "red dotted 2px";
    return;
  }
  newAuthorElement.style.backgroundColor = "var(--green";
  newAuthorElement.style.border = "none";
  newAuthorElement.placeholder = "Enter the Author [required]";
